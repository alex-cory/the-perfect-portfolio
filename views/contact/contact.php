<section id="contact" class="wrap content-section"></br></br></br></br>
    <div class="contact-section">
        <div class="container">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="fade-away">
                    <h2>Contact</h2>
                    <div class='main-content' id='mchead'>
                        ...
                        <p>Good luck:</p>
                            ...
                            <!-- <input type="text" name="emailaddress" placeholder='Email Address' class="emailaddress"></br> -->
