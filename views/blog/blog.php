<!--==== Blog Header Image ====-->
<section id="notes" class="wrap notes"></br></br></br></br>
    <div class="notes-body">
        <div class="container">
            <div class="row pull-left">
                <div class="col-md-20">
                    <h1 class="brand-heading">One Idea</h1>
                    <p class="intro-text pull-left">Can Make A Difference</p>
                </div>
            </div>
        </div>
    </div>
...
<?php // require_once './libraries/evernote-sdk-php/sample/client/EDAMTest.php'; ?>
<!--==== Blog Content ====-->
